...
public class CropImageView extends FrameLayout {
        ...
        if (listener != null) {
            CropResult cropResult =
                    new CropResult(
                            ...
                            getWholeImageRect(),
                            getRotatedDegrees(),
                            result.sampleSize, (getCropShape() == CropImageView.CropShape.RECTANGLE ? 1 : 2));
    ...
    public static class CropResult {
        ...
        private final int mCropImageShape;
        ...
        CropResult(
                ...
                Rect wholeImageRect,
                int rotation,
                int sampleSize, int CropImageShape) {
            ...
            mCropImageShape = CropImageShape;
        }
        ...
        public int getCropImageShape() {
            return mCropImageShape;
        }
    }
    // endregion
}
