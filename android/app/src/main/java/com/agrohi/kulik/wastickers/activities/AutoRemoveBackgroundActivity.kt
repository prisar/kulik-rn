...
import com.agrohi.kulik.wastickers.tf.ImageSegmentationModelExecutor
import com.agrohi.kulik.wastickers.tf.MLExecutionViewModel
...
import com.agrohi.kulik.wastickers.tf.CameraFragment
import com.agrohi.kulik.wastickers.tf.ModelExecutionResult
...
private const val TAG = "AutoRemove"

public class AutoRemoveBackgroundActivity : AppCompatActivity(), CameraFragment.OnCaptureFinished {
    ...
    override fun onCaptureFinished(file: File) {
        ...
        Log.d(TAG, msg)
        Log.d(TAG, "lastsave file ${lastSavedFile}")
